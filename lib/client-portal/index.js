...
class ClientPortal {
    ...
    handleClientConnections() {
        ...
        io.on('connect', socket => {
            ...
            this.banker.registerClient(socket.id, 1500); // todo: try to retrieve first

            table.tableEvent.emit('player-joined', guestname, socket.id, (playername, tableid, assignedSeat, seatStates, balance, cb) => {
            ...
            // socket.on('player-completed-action', (data) => {
            ...
            // socket.on('poll-game-state', (data) => {
            //     this.tables.get(data.tableid).tableEvent.emit(
            //         'poll-game-state',
            //         socket.id,
            //         data.gameid
