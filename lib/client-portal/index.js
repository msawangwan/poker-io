...
class ClientPortal {
    ...
    handleClientConnections() {
        ...
        io.on('connect', socket => {
            ...
            table.tableEvent.emit('player-joined', guestname, socket.id, (playername, tableid, assignedSeat, seatStates) => {
