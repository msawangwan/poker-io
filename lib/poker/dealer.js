class Dealer {
    ...
    // toggleActingPlayerByBetOrder(previous, next) {
    //     if (previous !== null) {
    ...
    updatePlayerStateOnActionCompleted(playerState, completedAction, clientRound, betAmount) {
        ...
        roundState.amountBetThisRound += betAmount;
