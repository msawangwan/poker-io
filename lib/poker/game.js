...
class Game {
    constructor(id, positions, buttonPosition) {
        ...
        this.gameEvent.once('game-start', (onstart) => {
            ...
            // this.dealer.cycleActiveRoundByName('start'); // TODO THIS IS THE BROKE PART
            this.dealer.updateRoundStateOnPlayerCompletedAction(null, 'start');
    ...
    playerCompletedAction(id, round, action, orderIndex, amount) {
        ...
        switch (round) {
            case 'blind':
                if (curupdated.position.isBigBlind) {
                    this.dealer.updateRoundStateOnPlayerCompletedAction(curupdated, round);
        ...
        round = this.dealer.activeRound.name;
