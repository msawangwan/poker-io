...
class Game {
    constructor(id, positions, buttonPosition) {
        ...
        this.gameEvent.once('game-start', (onstart) => {
            ...
            this.dealer.validateRoundState('start');
    ...
    playerCompletedAction(id, clientRoundName, action, orderIndex, amount) {
        ...
        if (!this.dealer.validateSentStateMatchesServerState(id, clientRoundName)) {
            Game.log(
        ...
        const curupdated = this.dealer.validatePlayerBet(cur, action, clientRoundName, amount);
        const roundupdated = this.dealer.validateRoundState(clientRoundName, curupdated, action);
        ...
        switch (clientRoundName) {
            ...
            case 'flop':
                ...
                // this.dealer.setPlayerStatesOnRoundChange();
                break;
            default:
                break;
        }
