...
class Game {
    ...
    nextState(current) {
        ...
        const clear = (round) => {
            // const acting = [...this.player.states].find(p => p[1].isSmallBlind)[1];
        ...
        switch (current) {
            ...
            case 'deal':
                ...
                // this.actingPlayer.id = this.player.byOrderIndex(0).id;
                // this.actingPlayer.id = [...this.player.states].find(p => p[1].isSmallBlind).id;
                // this.leadPlayer.id = [...this.player.states].find(p => p[1].isDealer)[1].id;
