...
class Game {
    ...
    playerCompletedAction(id, round, action, orderIndex, amount) {
        ...
        switch (round) {
            case 'blind':
                actid = this.dealer.handleBlind(id);
                ...
                break;
            case 'deal':
                actid = this.dealer.handleBet(id, amount, action, round);
        ...
        console.log("***");
        console.log("ACIONT WAS ACTTUALLY COMPLETED WITHD ID : " + actid);
        console.log("ACIONT WAS ACTTUALLY COMPLETED WITHD ID : " + actid);
        console.log("ACIONT WAS ACTTUALLY COMPLETED WITHD ID : " + actid);
        console.log("***");
        console.log("BET ANCHOR " + this.dealer.betAnchor.actionId);
        console.log("BET ANCHOR " + this.dealer.betAnchor.actionId);
        console.log("BET ANCHOR " + this.dealer.betAnchor.actionId);
        console.log("***");

        const current = this.dealer.getStateByPlayerId(id);
        const latestActionId = this.dealer.getStateLatestActionId(current);

        if ((current.isBetAnchor) && (actid !== this.dealer.betAnchor.actionId)) {
            // if ((current.isBetAnchor) && (latestActionId !== this.dealer.lastActionId)) {
            console.log("THIS IS THE BET ANCHOROROROROROROR");
            console.log("THIS IS THE BET ANCHOROROROROROROR");
            console.log("THIS IS THE BET ANCHOROROROROROROR");
            console.log("THIS IS THE BET ANCHOROROROROROROR");
            console.log("THIS IS THE BET ANCHOROROROROROROR");
        } else {
            if (current.isBetAnchor) {
                console.log("REACEHD BET ANCHOR BUT WE JUST BECAME THE BETCNAHOR");
                console.log("REACEHD BET ANCHOR BUT WE JUST BECAME THE BETCNAHOR");
                console.log("REACEHD BET ANCHOR BUT WE JUST BECAME THE BETCNAHOR");
                console.log("REACEHD BET ANCHOR BUT WE JUST BECAME THE BETCNAHOR");
                console.log("REACEHD BET ANCHOR BUT WE JUST BECAME THE BETCNAHOR");
        ...
        console.log("DO WE HVAE AN ACTUAL HISTORY?????");
        console.log(current.bet.historyIds);
        console.log("LAST ACTION ID");
        console.log(this.dealer.lastActionId);

        console.log("WTFFFF");
        console.log(current.bet.lastAction(current.bet.historyIds));
