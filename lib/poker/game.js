...
class Game {
    ...
    validateTurn(playerId, actionType, betAmount) {
        ...
        console.log(`validate turn:\npid: ${player.id}\nbet order index: ${player.betOrderIndex}\nbet amount: ${betAmount}`);
        console.log(`pot before:\ntotal: ${this.pot.size}\ncurrent: ${this.pot.sizeCurrent}`);
        console.log(`state before: ${this.currentState}`);
        console.log(`lead player before:`);
        ...
        console.log(`pot after:\ntotal: ${this.pot.size}\ncurrent: ${this.pot.sizeCurrent}`);
        console.log(`state after: ${this.currentState}`);
        console.log(`next player bet index: ${betOrderIndexNext}`);
        console.log(`lead player after:`);
        console.log(this.leadPlayer);
        console.log('turn data:');
        console.log(turn);
    ...
    startTurn(betOrderIndex, lastBetAmount) {
        console.log(`turn started for turn: ${betOrderIndex}`);
        console.log(`current game state: ${this.currentState}`);
        console.log(`previous bet amount: ${lastBetAmount}`);
