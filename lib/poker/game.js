...
class Game {
    constructor(id, players) {
        ...
        this.gameEvent.once('pass-the-button', (socketconn, roomid) => {
            {
                console.log('===');
                console.log('on the button currently: ');
                console.log(this.onTheButton);
                console.log('===');
            }

            socketconn.in(roomid).emit('on-the-button', {
                button: this.onTheButton,
                smallblind: this.onTheButton + 1 % this.playerCount(),
                bigBlind: this.onTheButton + 2 % this.playerCount()
            });

            this.onTheButton += 1 % this.playerCount();
        });
