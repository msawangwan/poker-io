...
class Game {
    constructor(players) {
        ...
        this.positions = {
            onTheButton: this.lastPlayerIndex,
            smallBlind: () => this.positions.onTheButton + 1 % this.playerCount,
            bigBlind: () => this.positions.onTheButton + 2 % this.playerCount
        };

        this.gameEvent = new GameEvent();

        this.gameEvent.once('start', () => {

        });

        this.gameEvent.on('deal', () => {
