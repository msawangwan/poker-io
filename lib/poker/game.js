...
class Game {
    ...
    playerCompletedAction(id, round, action, orderIndex, amount) {
        ...
        switch (round) {
            case 'blind':
                completedActionId = this.dealer.handleBlind(id);
                ...
                break;
            case 'deal':
                completedActionId = this.dealer.handleBet(id, amount, action, round);
        ...
        console.log("***");
        console.log("ACIONT WAS ACTTUALLY COMPLETED WITHD ID : " + completedActionId);
        console.log("***");
        ...
        if ((current.isBetAnchor) && (completedActionId !== this.dealer.betAnchor.actionId)) {
            console.log("THIS IS THE BET ANCHOROROROROROROR");
            handleBetAnchor(action);
        } else {
