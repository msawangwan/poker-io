...
class Game {
    constructor(id, positions, buttonPosition) {
        ...
        this.gameEvent.once('game-start', (onstart) => {
            ...
            this.dealer.oneTimeInit(this.blindBetSize);
            this.dealer.determineSeatingAndInitPlayerStates(this.positions, this.buttonPosition);
    ...
    playerCompletedAction(id, round, action, orderIndex, amount) {
        ...
        const next = this.dealer.toggleActingPlayer(orderIndex, nextOrderIndex);
