...
class Game {
    constructor(id, players, button) {
        ...
        //     this.gameEvent.emit('notify-next-action', nextToActId, 'bigblind', this.minbet);
        //     this.passActionToNextPlayer();
        ...
        //     this.gameEvent.emit('notify-next-action', nextToActId, 'anteup', this.minbet);
        //     this.passActionToNextPlayer();
        ...
        //     this.gameEvent.emit('notify-next-action', nextToActId, 'checkorraise', this.minbet)
        //     this.passActionToNextPlayer();
        ...
        //     this.gameEvent.emit('notify-next-action', nextToActId, 'callorreraiseorfold', this.minbet)
        //     this.passActionToNextPlayer();
