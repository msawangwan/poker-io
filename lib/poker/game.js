...
class Game {
    ...
    playerCompletedAction(id, roundName, action, orderIndex, amount) {
        ...
        const roundStateUpdated = this.dealer.updateGameState(playerStateUpdated, this.dealer.currentPot.bets.min);
        ...
        const nextPlayerAllowedActions = this.dealer.getAllowedActionsForPlayer(
            next,
            this.dealer.currentPot.bets.min,
            roundName
        );
