...
class Table {
    constructor(numberOfSeats, socketconn, banker) {
        ...
        this.tableEvent.on('bet-action', (betActionType, betPhase, betAmount, playerid, gameid) => {
            const game = this.games.get(gameid);
            const seatIndex = this.players.get(playerid);
            ...
            game.gameEvent.emit(
                ...
                (betType, betPhase, betAmount, potsize, newBalance, playerid, playername, playerseatindex) => {
